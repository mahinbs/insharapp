...
const barterOffers = [
  {
    ...
    businessLogo: "https://readdy.ai/api/search-image?query=Elegant%20restaurant%20logo%2C%20modern%20dining%20establishment%2C%20sophisticated%20branding%2C%20clean%20minimalist%20design%2C%20professional%20restaurant%20identity%2C%20upscale%20dining%20logo&width=80&height=80&seq=resto1&orientation=squarish",
  ...
  },
  {
    ...
    businessLogo: "https://readdy.ai/api/search-image?query=Luxury%20beauty%20salon%20logo%2C%20elegant%20spa%20branding%2C%20premium%20beauty%20services%20logo%2C%20sophisticated%20wellness%20brand%20identity%2C%20minimalist%20beauty%20logo%20design&width=80&height=80&seq=salon1&orientation=squarish",
    offerImage: "https://readdy.ai/api/search-image?query=Luxury%20beauty%20salon%20interior%2C%20professional%20hair%20styling%20session%2C%20elegant%20spa%20treatment%20room%2C%20modern%20beauty%20salon%20equipment%2C%20relaxing%20wellness%20environment&width=300&height=200&seq=beauty1&orientation=landscape",
  ...
  },
  {
    ...
    businessLogo: "https://readdy.ai/api/search-image?query=Modern%20fashion%20boutique%20logo%2C%20trendy%20clothing%20brand%20identity%2C%20urban%20fashion%20logo%2C%20stylish%20apparel%20branding%2C%20contemporary%20fashion%20design&width=80&height=80&seq=fashion1&orientation=squarish",
    offerImage: "https://readdy.ai/api/search-image?query=Trendy%20fashion%20boutique%20interior%2C%20stylish%20clothing%20display%2C%20modern%20retail%20store%2C%20fashionable%20apparel%20collection%2C%20contemporary%20shopping%20experience&width=300&height=200&seq=clothes1&orientation=landscape",
      ...
      <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-orange-500 px-6 pt-12 pb-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-white font-semibold text-lg">Welcome back, Sarah!</h1>
              <p className="text-white/80 text-sm">@sarahstyles • 25K followers</p>
            </div>
          </div>
      ...
      <div className="px-6 py-6">
        {activeTab === 'available' && (
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Available Barter Offers</h2>
                ...
                <div className="p-4">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">{offer.category} • {offer.location}</p>
                    </div>
                  </div>
                  
                  <h4 className="font-bold text-lg text-gray-800 mb-2">{offer.title}</h4>
        ...
        {activeTab === 'collaborations' && (
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-gray-800 mb-4">My Collaborations</h2>
            {myCollaborations.map((collab) => (
              <div key={collab.id} className="bg-white rounded-2xl p-4 shadow-lg">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-semibold text-gray-800">{collab.businessName}</h3>
